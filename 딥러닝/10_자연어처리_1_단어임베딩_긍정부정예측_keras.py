# -*- coding: utf-8 -*-
"""10. 자연어처리#1_단어임베딩_긍정부정예측_keras.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11OXQ6gds6LrlYA3olO2j4yWtQg0qWbOQ
...
Image('/content/drive/MyDrive/ComputerProgramming/DeepLearning/2.딥러닝/rnn/같은의미.png', width=500)
...
with open('/content/NLP_bow.txt') as f:
  docs = f.readlines()
docs
...
Image('/content/drive/MyDrive/ComputerProgramming/DeepLearning/2.딥러닝/rnn/원-핫인코딩vs단어임베딩.png')

Image('/content/drive/MyDrive/ComputerProgramming/DeepLearning/2.딥러닝/rnn/단어유사도.png')
# 단어의 유사도 샘플
...
Image('/content/drive/MyDrive/ComputerProgramming/DeepLearning/2.딥러닝/rnn/분절.png')
...
# 대량 데이터 
train_txt = "/content/drive/MyDrive/ComputerProgramming/DeepLearning/2.딥러닝/rnn/ratings_train.txt"
test_txt = "/content/drive/MyDrive/ComputerProgramming/DeepLearning/2.딥러닝/rnn/ratings_test.txt"
...
# document -> 하나씩 꺼내서 -> macab으로 토큰화 -> ' '를 구분자로 문자열 통합 -> 대체 -> apply()
