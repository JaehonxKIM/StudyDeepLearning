...
Original file is located at
    https://colab.research.google.com/drive/1VnZxnyHLNl6DPy7jgocrj3dh8r6hr28K
...
"""- 원리
  ...
  - cnn에서 컴볼루션층은 레이어를 지나온 데이터들은 입력 데이터의 속성을 잘 간진하고 있다(단, 1D으로 축소하면 정보손실이 발생) -> 이를 중간맵 이라 한다면
